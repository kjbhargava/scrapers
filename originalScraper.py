...
class Scraper():
    ...
    def __initDrivers(self):
        ...
        self.driver.get(
        "https://www.southtechhosting.com/SanJoseCity/CampaignDocsWebRetrieval/Search/SearchByFiledForm.aspx")
        try:
        ...
        elem = self.driver.find_element(By.ID, 'ctl00_DefaultContent_ASPxRoundPanel1_ASPxDDL_Forms_B-1')
        elem.Click()
        elem.send_keys("460 Recipient Committee Campaign Statement")
        elem.send_keys(Keys.RETURN)

        search_button = self.driver.find_element(By.Id, 'ctl00_DefaultContent_ASPxRoundPanel1_btnFindFilers_I')
        search_button.Click()
        search button id = ctl00_DefaultContent_ASPxRoundPanel1_btnFindFilers_I
